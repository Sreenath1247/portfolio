...
export default function Hero({ name, specialty, summary, email }: HeroProps) {
  return (
    <section className="py-24 md:py-32" id="hero">
      ...
      <p className="mb-9 font-serif text-4xl leading-11.5 font-bold tracking-tighter text-primary sm:text-5xl md:text-6xl">
        {specialty}
      </p>
      <p className="mb-16 text-base font-normal text-neutral md:text-lg">{summary}</p>
      <a
